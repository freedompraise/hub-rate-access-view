...
const AccessRequestModal = ({ isOpen, onClose }: AccessRequestModalProps) => {
  ...
  if (isSubmitted) {
    return (
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="bg-charcoal-gray border-royal-gold/20 text-white max-w-md">
          <div className="text-center py-6">
            <div className="w-16 h-16 bg-royal-gold rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-midnight-black" fill="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="text-royal-gold font-montserrat font-semibold text-xl mb-2">
            ...
            <Button
              ...
              className="bg-royal-gold hover:bg-button-hover text-midnight-black font-montserrat font-semibold uppercase transition-all duration-300"
            >
              Chat on WhatsApp
            </Button>
          </div>
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-charcoal-gray border-royal-gold/20 text-white max-w-md">
        <DialogHeader>
          <DialogTitle className="text-royal-gold font-montserrat font-semibold text-xl text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <Button
            ...
            className="w-full bg-royal-gold hover:bg-button-hover text-midnight-black font-montserrat font-semibold uppercase transition-all duration-300 mt-6"
          >
